...
* For optimal performance, you must manually define constraints like NOT NULL, Primary key, and Foreign key in Query Optimizer after the tables are synced using ALTER TABLE.
* The Optimizer dashboard supports statistics collection only.
