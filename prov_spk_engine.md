...
{{site.data.keyword.lakehouse_full}} allows you to add Spark engines. You can provision a native Spark engine.
{: shortdesc}
...
6. In the **Add component - IBM Spark** page, choose the engine type from the **Type** list. You can select Spark or Gluten accelerated Spark. Configure the following details:
      ...
      |Reserve capacity (Conditional)| Specify this field if you are using a version earlier than 2.3 of {{site.data.keyword.lakehouse_short}}. \n 1. Select the **Node Type**. \n 2. Enter the number of nodes in the **No of nodes** field.     |
