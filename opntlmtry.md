...
OpenTelemetry is available only for the Presto (Java) and Spark engine in the {{site.data.keyword.lakehouse_full}} Enterprise edition, and only in the `jp-tok` region.
