...
1. The **Welcome to IBM watsonx.data** page is the entry point for setting up your {{site.data.keyword.lakehouse_short}}. It introduces the core value of {{site.data.keyword.lakehouse_short}} and helps you choose an initial configuration based on your workload and performance goals.
