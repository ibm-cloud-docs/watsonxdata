...
{: shortdesc}
 ...
 If you select **Redis** from the **Database type** drop-down list, configure the following details:
...
You can add tables after creating the database from the View database page.
{: note}
