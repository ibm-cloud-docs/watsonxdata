...
For watsonx.data on-prem what's new, see [Release notes for {{site.data.keyword.lakehouse_short}}](https://www.ibm.com/docs/en/watsonx/watsonxdata/2.2.x?topic=watsonxdata-whats-new-in).
