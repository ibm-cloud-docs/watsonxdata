...
3. Configure the MDS connection details in the AWS EMR cluster to connect to the {{site.data.keyword.lakehouse_short}} Metadata Service (MDS). A sample command to use spark-submit from an EMR 7.3.0 (Spark 3.5.1) based cluster is as follows:
    ...
    spark-submit \
    --deploy-mode cluster \
    --jars https://repo1.maven.org/maven2/org/apache/iceberg/iceberg-spark-3.5_2.12/1.4.0/iceberg-spark-3.5_2.12-1.4.0.jar,/usr/lib/hadoop/hadoop-aws.jar,/usr/share/aws/aws-java-sdk/aws-java-sdk-bundle*.jar,/usr/lib/hadoop-lzo/lib/* \
