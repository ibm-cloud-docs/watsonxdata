...
{: #snowflake_database1}
 ...
 | Passphrase (optional) | Enter the passphrase for the private key if it is encrypted. This field is displayed when **Private key** authentication type is selected. |
