...
SingleStore is a relational database management system designed for data-intensive applications.
{: shortdesc}

 Configure the following details for SingleStore data source:
...
1. `BLOB` and `CLOB` data types supports only `SELECT` statement.
