...
1. Under **Retrival service** section, choose one of the following avialble AI models:
   ...
   - **gpt-oss-120b**
    To use **gpt-oss-120b** with the Retrieval Service, you must first deploy the model. For detailed instructions, see [Deploying foundation models on demand (fast path)](https://dataplatform.cloud.ibm.com/docs/content/wsj/analyze-data/deploy-on-demand-resource-hub.html?context=wx&audience=wdp).
    {: note}
