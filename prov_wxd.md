...
- The Lite plan is limited to 500 resource units (RUs) before the instance is suspended. The cap value is displayed on the {{site.data.keyword.Bluemix_notm}} catalog provisioning page and is reflected on your billing page within your {{site.data.keyword.lakehouse_short}} instance upon provisioning. Your plan expires on reaching either the limit of 500 RUs or exceeding the trial period of 30 days.
...
- In Lite plan instances, users with {{site.data.keyword.lakehouse_short}} instance access can view Milvus services but are restricted from performing any write operations or administrative tasks.
